        ...
        <div className="h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button
              ...
              aria-label={hu ? 'Switch to English' : 'Váltás magyarra'}
            >
              {lang === 'hu' ? 'EN' : 'HU'}
            </button>
            ...
            <button
              ...
              aria-label={hu ? 'Éjszakai mód' : 'Dark mode'}
            >
              {dark ? (
            ...
            {user && (
              <div ref={notifRef} className="relative">
                <button
                  ...
                  aria-label={hu ? 'Értesítések' : 'Notifications'}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {user && (
              <button
                ...
                aria-label={mobileOpen ? (hu ? 'Menü bezárása' : 'Close menu') : (hu ? 'Menü megnyitása' : 'Open menu')}
